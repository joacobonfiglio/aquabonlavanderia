...
export default function ArticleLayout({title,description,slug,date,readingTime,cluster,image,children}:ArticleLayoutProps){
  ...
  return <main className="blog-article">
    ...
    <div className="article-shell"><article className="article-body">{children}</article><aside className="article-aside"><p className="eyebrow">¿PREFERÍS NO HACERLO EN CASA?</p><h2>Lavado de acolchados</h2><p>Revisamos tamaño, tejido, relleno y estado antes de confirmar el proceso.</p><Link href="/servicios/lavado-de-acolchados">Ver el servicio <span>↗</span></Link><WhatsAppLink message="Hola Aquabon, quería consultar por el lavado de un acolchado." event="whatsapp_blog_sidebar">Consultar por WhatsApp ↗</WhatsAppLink></aside></div>
