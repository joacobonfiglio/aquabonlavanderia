...
"/tintoreria-centro-mar-del-plata":base("/tintoreria-centro-mar-del-plata","Tintorería en el centro de Mar del Plata","Recibimos sacos, tapados, vestidos, camperas y prendas especiales en Gascón 2189. Revisamos cada pieza antes de confirmar el tratamiento, el precio y el plazo.","whatsapp_tintoreria_centro","Hola Aquabon, quería consultar por una prenda de tintorería en el centro de Mar del Plata.",[
 {title:"Recepción en el Centro",copy:"Acercá la prenda a Gascón 2189. Registramos etiqueta, tejido, forro, accesorios, manchas y cualquier daño previo."},
 {title:"Evaluación antes de confirmar",copy:"No todas las prendas necesitan el mismo proceso. Te indicamos viabilidad, límites, precio y plazo después de revisarla."},
 {title:"Seguimiento por WhatsApp",copy:"Cuando corresponde un tratamiento especializado, lo coordinamos fuera del local y te avisamos cuando la prenda vuelve disponible."}
],[
 {question:"¿Dónde queda la tintorería de Aquabon?",answer:"La recepción y entrega se realiza en Aquabon, Gascón 2189, en el centro de Mar del Plata."},
 {question:"¿Qué prendas reciben?",answer:"Recibimos sacos, trajes, tapados, vestidos, camperas y otras prendas especiales, siempre sujetas a revisión previa."},
 {question:"¿La limpieza especializada se realiza en el local?",answer:"Aquabon funciona como punto de recepción y seguimiento. Cuando la prenda requiere un tratamiento especializado, lo coordinamos fuera del local."},
 {question:"¿Cuánto cuesta y cuánto demora?",answer:"Depende de la prenda, el proceso necesario y su estado. Confirmamos precio y plazo después de verla, antes de aceptar el trabajo."},
 {question:"¿Salen todas las manchas?",answer:"No se puede garantizar. El resultado depende del origen y antigüedad de la mancha, el tejido, el color y los tratamientos aplicados antes."},
 {question:"¿Puedo enviar una foto por WhatsApp?",answer:"Sí, una foto sirve para una orientación inicial, pero la viabilidad, el precio y el plazo se confirman al revisar la prenda en persona."}
],{title:"Tintorería en el centro de Mar del Plata | Aquabon",description:"Tintorería con recepción en Gascón 2189, centro de Mar del Plata. Sacos, tapados, vestidos y prendas especiales con evaluación y seguimiento.",eyebrow:"TINTORERÍA · CENTRO DE MAR DEL PLATA",cta:"Consultar mi prenda",showLocation:true,sections:[
 {heading:"Una tintorería cerca, con evaluación clara",text:"La búsqueda de una tintorería en el Centro suele empezar por cercanía, pero la decisión también depende de qué recibe, cómo evalúa la prenda y qué información brinda. En Gascón 2189 podés dejarla y conocer las condiciones antes de confirmar."},
 {heading:"El tratamiento se elige para la prenda completa",text:"No decidimos solo por el tejido exterior. Etiqueta, forro, entretelas, hombreras, botones, adornos, manchas y reparaciones previas pueden cambiar el proceso recomendado o limitar el resultado."},
 {heading:"Recepción y seguimiento desde Aquabon",text:"Cuando hace falta un tratamiento especializado, coordinamos el servicio fuera del local. Aquabon centraliza la recepción, el registro, el seguimiento y la entrega para que tengas un único punto de contacto."}
],related:[{label:"Servicio de tintorería",href:"/servicios/tintoreria"},{label:"Guía: qué prendas llevar",href:"/blog/que-prendas-conviene-llevar-a-la-tintoreria"},{label:"Camperas y tapados",href:"/servicios/lavado-de-camperas-y-tapados"},{label:"Todas las guías",href:"/blog"}]}),
...
],{related:[{label:"Tintorería en el Centro",href:"/tintoreria-centro-mar-del-plata"},{label:"Lavado de camperas y tapados",href:"/servicios/lavado-de-camperas-y-tapados"},{label:"Guía: qué prendas llevar a tintorería",href:"/blog/que-prendas-conviene-llevar-a-la-tintoreria"},{label:"Todos los servicios",href:"/servicios"}]}),
