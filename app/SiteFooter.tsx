...
const serviceLinks = [
  ...
  ["Arreglos y costura", "/servicios/arreglos-y-costura"], ["Lavado de zapatillas", "/servicios/lavado-de-zapatillas"],
];
export default function SiteFooter() {
  return <footer className="site-footer seo-footer">
    ...
    <nav className="site-footer-links" aria-label="Navegación del pie">
      ...
      <div><span>LAVANDERÍA EN MAR DEL PLATA</span><Link href="/lavanderia-mar-del-plata">Lavandería en Mar del Plata</Link><Link href="/lavanderia-centro-mar-del-plata">Lavandería en el centro</Link><Link href="/nosotros">Nosotros</Link></div>
